...
namespace DataDownloader.Commands
{
    class GetDataCommand : Command, ICommand
    {
        ...
        public GetDataCommand(string name, string description, TargetFolderSettings settings, IHttpClientFactory clientFactory, ILogger<GetDataCommand> logger) : base(name, description)
        {
            _settings = settings;
